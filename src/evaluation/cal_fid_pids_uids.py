...
if __name__ == '__main__':
    ...
    # folder1 = '/data1/hn/code/AttDiff Comparative experiment/RePaint-main/log/ACP/gt'
    # folder1 = '/data1/hn/code/ACP-main/outputs/gt'
    ...
    # folder1 = '/data1/hn/code/TransCNN-HAE-master/checkpoints/results0/output'
